...
from jumanji.environments.routing.connector_3d.generator import (
    Generator,
    RandomWalkGenerator,
)
from jumanji.environments.routing.connector_3d.reward import DenseRewardFn, RewardFn
from jumanji.environments.routing.connector_3d.types import Agent, Observation, State
...
from jumanji.environments.routing.connector_3d.viewer import ConnectorViewer
...
class Connector(Environment[State, specs.MultiDiscreteArray, Observation]):
    ...
    - observation - `Observation`
        - action mask: jax array (bool) of shape (num_agents, 7).
        - step_count: jax array (int32) of shape ()
            the current episode step.
        - grid: jax array (int32) of shape (grid_size, grid_size, 2)
    ...
    - action: jax array (int32) of shape (num_agents,):
        - can take the values [0,1,2,3,4,5,6] which correspond to [No Op, Up, Right, Down, Left, zup, zdown].
    ...
    - state: State:
        ...
        - grid: jax array (int32) of shape (grid_size, grid_size, 2) giving the observation.
    ...
    def __init__(
        ...
        Args:
            ...
            viewer: `Viewer` used for rendering. Defaults to `ConnectorViewer` with "human" render
                mode.
        """
        self._generator = generator or RandomWalkGenerator(grid_size=(10, 10, 2), num_agents=10)
    ...
    def action_spec(self) -> specs.MultiDiscreteArray:
        ...
        7 actions: [0,1,2,3,4,5,6] -> [No Op, Up, Right, Down, Left, Zup, Zdown]. Since this is an environment with
        ...
        return specs.MultiDiscreteArray(
            num_values=jnp.array([7] * self.num_agents),
            dtype=jnp.int32,
            name="action",
        )
